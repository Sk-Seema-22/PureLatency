        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 2 }}>
              ...
              <h3 style={{ fontSize: '1.8rem', fontWeight: 400, marginBottom: '1rem' }}>One Workspace, Endless Possibilities</h3>
                ...
                {benefits.map(benefit => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ color: '#86868b', fontSize: '0.85rem' }}>{benefit.statDesc}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {features.map(feature => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: '#86868b', fontSize: '1rem', lineHeight: '1.7', marginBottom: '1rem' }}>
                      {feature.desc}
                    </p>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                      {feature.details.map(detail => (
              ...
              {pricing.map(plan => (
                ...
                >
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    <span style={{ fontSize: '2.5rem', fontWeight: 300, color: plan.color }}>{plan.price}</span>
          ...
          <div style={{
            ...
            {integrations.map(integration => (
              ...
              >
                ...
                <div style={{ fontSize: '0.8rem', color: '#86868b' }}>{integration.name}</div>
              </div>
            ))}
          </div>
        </section>
          ...
          <div style={{
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} style={{
                ...
                <span style={{ fontSize: '4rem', color: '#7C3AED', opacity: 0.2, position: 'absolute', top: '10px', left: '20px' }}>"</span>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ 
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                <li style={{ marginBottom: '0.5rem' }}><Link href="/products/starling-post" style={{ color: '#aaa', textDecoration: 'none' }}>Starling Post</Link></li>
                <li style={{ marginBottom: '0.5rem' }}><Link href="/products/nexus-flow" style={{ color: '#aaa', textDecoration: 'none' }}>Nexus Flow</Link></li>
                <li style={{ marginBottom: '0.5rem' }}><Link href="/products/aether-ai" style={{ color: '#aaa', textDecoration: 'none' }}>Aether AI</Link></li>
              </ul>
            </div>
            <div>
